...
public class TagInit
{
    ...
    public static final TagKey<Biome> NO_SPAWN_BIOMES = TagKey.of(RegistryKeys.BIOME, new Identifier("ward_blocks", "no_spawn_biomes"));
    public static final TagKey<Biome> ONLY_SPAWN_BIOMES = TagKey.of(RegistryKeys.BIOME, new Identifier("ward_blocks", "only_spawn_biomes"));
